...
\begin{itemize}
	\item{Einleitung}
  \subitem{Worum es geht und worum nicht}
  \subitem{Forschungsfragen}
  ...
  \subitem{Interview}
  \subitem{Vergleich}
  \subitem{Qualitative Quellenanalyse (Kategorisierung der Personen, Gruppen und Argumente)}
  \item{Historischer Kontext: Von der Kuhpocken zur Rotavierenimpfung}
  \item{Auswertung und Kategorisierung der Argumente des 18. u. 19. Jahrhunderts}
  \item{Auswertung und Kategorisierung der Interviews}
\item{Auswertung und Kategorisierung der Argumente des 20. u. 21. Jahrhunderts}
\item{Vergleich}
\item{Conclusio (Beantwortung der Fragen)}
